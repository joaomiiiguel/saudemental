...
function c(){
    var ag=x.fullInstall?"UnityWebPlayerFull.exe":"UnityWebPlayer.exe";
    if(x.referrer!==null){
...
var j=function(){
    ...
    ah.push(["unity._setCustomVar",1,"Revision","e444f76e01cd",2])
    }
    ...
    an+="&v="+encodeURIComponent("e444f76e01cd");
    if(x.referrer!==null){
        an+="?r="+x.referrer
        }
        if(ap){
